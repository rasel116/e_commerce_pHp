				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								<li><i class="ti-location-pin"></i><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-shopping-cart"></i> Cart</a></button></li>
								 <?php if (isset($_SESSION['CUSID'] )) { ?> 
                                                                <li><i class="ti-alarm-clock"></i> <a href="#">Daily deal</a></li>
								<li><i class="ti-user"></i> <a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i> Account</a></li>
								
                                                               <li><i class="ti-power-off"></i><a   href="<?php echo web_root?>logout.php"><i class="fa fa-lock"></i> Logout</a></li>
                                                                 <?php }else{ ?> 
                                                               <li><i class="ti-power-off"></i><a data-target="#smyModal" data-toggle="modal"  href=""><i class="fa fa-lock"></i> Login</a></li>
							 <?php } ?>
                                                        </ul>
							...
							<div class="sinlge-bar shopping">
								...
								<div class="shopping-item">
									<div class="dropdown-cart-header">
                                                                               <!-- <span >2 Items</span>-->
										<a href="<?php echo web_root;?>index.php?q=cart">View Cart</a>
									</div>
									...
									<div class="navbar-collapse">	
                                       ...
                                       echo '<li><a href="index.php?q=product&category='.$result->CATEGORIES.'" >'.$result->CATEGORIES.'</a></li>';
													...
													<li><a href="contact.html">Contact Us</a></li>
                                                                                                         <li><a href="<?php web_root?>index.php?q=product"><i class='fas fa-store-alt-slash'></i> Products</a></li>
                                                                                                         <li><a href="<?php web_root?>index.php?q=contact"><i class='fas fa-user-friends'></i> Contact</a></li>
												</ul>
