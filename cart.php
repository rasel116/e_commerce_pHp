...
?>
             ...
             ';
                                  ...
                                  &#2547  <?php echo  $result->PRODISPRICE ; ?>
                                  </td>
                                  
                                      
                                        <input type="hidden"    id ="TOT<?php echo $result->PROID;  ?>" name="TOT<?php echo $result->PROID; ?>" value="<?php echo  $result->PRODISPRICE ; ?>" >
                                   
                                     <td> &#2547 <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output></td>
                        ...
                        <h3 align="right"> Total  &#2547 <span id="sum">0</span></h3> 
    </div>
  </div>  
